      ...
      <Container>
        ...
        >
          <Typography marginBottom={4} sx={baseTextStyles}>
            Welcome to Punch Games! We hope you’ll enjoy being a part of our community by participating in online
          ...
          <Typography marginBottom={4} sx={baseTextStyles}>
            ...
            BELOW, DOWNLOADING ANY APPLICATION INTEGRATED WITH Punch Games, OR REGISTERING FOR OR PARTICIPATING IN ANY
            ...
            not register with Punch Games (“Punch Games”, “we” or “us”) and do not use the Services. Declining to
            accept these Terms means you will be unable to participate in Competitions or use your Punch Games
            account.
          </Typography>
          ...
          <Typography sx={baseTextStyles}>
            1.3. Eligibility. You may not modify these Terms except in writing signed by both you and Punch Games. For
          ...
          <Typography sx={baseTextStyles}>
            ...
            registration; (b) have the power to enter into a contract with Punch Games; (c) be physically located
...
In the event that the User has suspicions that the User Account may be being hijacked, he or she must contact Fantasy Game to proceed with its blocking and, where appropriate, proceed to change the password. In the event of any suspicion that the password may have been disclosed to third parties, Fantasy Game recommends that it be changed immediately. In any case, for security reasons, it is recommended to change your password from time to time. Punch Games reserves the right to prevent the opening of a User Account when the holder of the User Account is not the User himself/herself, or to suspend the User Account (in the event that it has been successfully opened) and to withhold the balance that may be held in it. In the event that there are indications of suspicion that the User Account is being used by someone other than the person listed in the registration, or that it is being used in a fraudulent manner, Punch Games may cancel the User Account if there are sufficient indications of fraudulent or illicit use of the User Account. Punch Games is not responsible for the access of third parties to the User Account and under no circumstances will it assume responsibility for any loss, costs, claims, expenses and damages that the User may incur as a result of the unauthorized use of the User Account by any another person, or as a result of unauthorized access to the User Account. In this sense, all transactions where the username and password appear correctly will be considered valid, whether they have been authorized by the User. 
          </Typography>
...
The User may request the temporary or permanent closure of their User Account. The voluntary closure period will be determined by the User, notifying the Punch Games Customer Service. In the event that the User requests the permanent closure of the User Account, it may not be reopened. 
          </Typography>
...
The User agrees not to upload, communicate, transmit or otherwise make available content in the available chats or elsewhere on the Platform: (i) which is or may reasonably be considered to be illegal, harmful, harassing, defamatory, libellous, obscene or otherwise objectionable; (ii) which is or may reasonably be considered to be an infringement of other people's privacy; (iii) which is or may reasonably be considered to incite violence or racial or ethnic hatred; (iv) which you are not entitled to legally provide (such as information which is privileged, proprietary or confidential); (v) which infringes any intellectual property right or any other proprietary right of any third party; (vi) which contains software viruses or any other computer code, files or programs designed to interrupt, destroy or limit the functionality of the Platform or any computer software or hardware or telecommunications equipment, or which consists of unsolicited or unauthorised advertising, promotional materials, junk mail, spam, chain letters, pyramid schemes or other forms of solicitation. Likewise, the User declares, guarantees and agrees that: (i) he/she will not carry out a conduct that could damage the reputation of Punch Games; (ii) there is a risk of losing money by participating and/or using the Punch Games Services and you agree to be fully responsible for such losses; (iii) the use of the Punch Games Services is made at your sole risk and responsibility for what is left to your entire personal and individual decision; (iv) in relation to their losses, the User may not make any claim against Punch Games or its partners, directors, managers, executives or employees, without prejudice to the possibility of filing the corresponding complaints and claims with the Customer Service of Punch Games; (v) the origin of the funds that are deposited in the User Account for the use of the Punch Games Services is not illegal and that under no circumstances will you use the Punch Games Services as a deposit or money transfer system, also committing yourself to not use the Punch Games Services for any illegal, illicit or fraudulent activity. In accordance with the foregoing, if Punch Games suspects that a User is, or has been, part of a fraudulent, illegal activity or detects suspicious behaviour in relation to money laundering activities, or if the User proceeds in such a way as to breach the these Terms and Conditions, your access to the Punch Games Services may be immediately cancelled and/or your User Account blocked, in accordance with the provisions of these Terms and Conditions (without prejudice to the internal investigation actions that Punch Games may carry out, or exercise the legal actions that the parties may be entitled to). 
          </Typography>
...
Punch Games’ Designated Agent is:Magically Technology LLC,contact@Punch Games.me. 
          </Typography>
...
The Terms and Conditions are published so that they can be consulted at any time at the following link: www.Punch Games.com Punch Games reserves the right to modify, update and change the Terms and Conditions, as well as the Privacy Policy, the Cookies Policy and the rules that apply to each of the video games offered on the Platform, in which case it will inform the user of said modifications or changes, by publishing a new version of these Terms and Conditions on the Website and/or on the Platform. Notwithstanding the foregoing, and in accordance with the applicable regulations, the express consent of the User will be requested by means of a notification when logging into their User Account for the acceptance of the new version of the Terms and Conditions, and the User must expressly accept the new version of the Terms and Conditions. If you are not satisfied, you will not be able to continue participating in the Punch Games Services and you must immediately request that your account be blocked. In this case, and provided that there has been no breach of the Terms and Conditions by the User, the User will be reimbursed the balances that the User had available in his/her User Account at the time of closure or blocking of the account. 
          </Typography>
...
The resolution of incidents, complaints and claims in relation to the Punch Games Services will be carried out in accordance with the provisions of the Help section, included in the Platform and/or on the Website. The User may make any claim whenever he or she wishes to do so. To do this, you can write an e-mail to the address contact@Fantasygames.me. The User may file a claim within a period of three (3) months after the date of the circumstance that gave rise to the claim. The complaint shall always be dealt with by Punch Games in a mandatory manner, within a maximum period of one (1) month following receipt of the complaint. The User must indicate in his or her letter his or her Username and a brief description of the facts which are the subject of the complaint and his or her claims. Punch Games will not tolerate any threatening, damaging, abusive or violent behaviour by the User towards any of its employees. In the event that the User behaves in such a way (the determination of which will be at our sole discretion), Punch Games reserves the right to suspend and/or close their User Account, and/or to take the measures it deems appropriate. 
          </Typography>
...
18.7 Language of the Terms: If we provide a translated version of these Terms, the User Terms of Service, the Developer Terms and Conditions of Service, the Affiliate Program Terms of Service, the Punch Games Privacy Policy, or any other terms or policy, it is for informational purposes only. If the translated version means something different than the English version, then the English meaning will be the one that applies. 
          </Typography>
...
Please send any questions or comments (including all inquiries unrelated to copyright infringement) to: Punch Games Customer Support, P.O. Box 445, San Francisco, CA 94104. Please print these Terms for your records. 
          </Typography>
...
At Punch Games Inc. (“Punch Games”, “we”, “us” or “our”), we take your privacy and the security of your information very seriously.This Privacy Policy Statement (“Privacy Policy”) covers Punch Games-owned and -operated websites, including Punch Games.com (“Site” or “Sites”), and any services offered by Punch Games including technology services that enable independent game developers to host tournaments and provide competitive gaming activity to end-users, and any use of the Punch Games SDK, including all Punch Games Public Forums, and the Developer Console (collectively, the “Services”). This Privacy Policy is incorporated into, and is part of, our Terms of Service available at https://www.fantasygames8.com which govern your access to the Site and your use of the Site and/or Services. Unless otherwise defined herein, capitalized terms shall have the meaning assigned to such terms in the Terms of Service. 
          </Typography>

          <Typography sx={baseTextStyles}>

If you have any questions regarding this Privacy Policy, please contact us at contact@Punch Games.me. 
          </Typography>

          <Typography sx={baseTextStyles}>

For the purposes of EU data protection laws (“Data Protection Law”), Punch Games is a data controller (i.e., the company that is responsible for, and controls the processing of your personal data). 
          </Typography>
...
2.1.9 You may provide credit card information or your Paypal username to use certain features of the Services. Punch Games will use third-party credit card processing companies to process your transactions. Punch Games will not have access to your credit card data. 
          </Typography>
...
3.2 Certain Personal Information is transmitted to a third-party service provider for the purpose of processing any payments. The transmission of your payment information is automatic, and at no point do we, or any of our agents or employees, have the ability to review, access or retain such payment information. 3.3 Punch Games may also elect to transfer your Personal Information to third parties under special circumstances to: (i) to comply with a legal requirement, judicial proceeding, court order, or legal process served on Punch Games; (ii) to investigate a possible crime, such as fraud or identity theft; (iii) in connection with the sale, purchase, merger, reorganization, liquidation or dissolution of Punch Games; (iv) when we believe it is necessary to protect the rights, property, or safety of Punch Games or other persons; or (v) as otherwise required or permitted by law, including any contractual obligations of Punch Games. 
          </Typography>
...
Please contact support@Punch Games.com if you need details about the specific legal basis on which we are relying to process your personal data where more than one legal basis has been set out. 
          </Typography>
...
Pursuant to Section 1798.83 of the California Civil Code, residents of California have the right to request from a business, with whom the California resident has an established business relationship, certain information with respect to the types of Personal Information the business shares with third parties for direct marketing purposes by such a third party and the identities of the third parties with whom the business has shared such information during the immediately preceding calendar year. If you are a California resident and want a copy of this notice, please submit an email request to support@Punch Games.com. In your request, please specify that you want a “Your Punch Games Section 1798.83 California Privacy Rights Notice.” Please allow 30 days for a response. 
          </Typography>
...
The categories of Personal Information Punch Games has collected about you. 
          </Typography>
...
The categories of third parties with whom Punch Games has shared the information. 
          </Typography>

          <Typography sx={baseTextStyles}>

The specific pieces of Personal Information Punch Games has collected about you. 
          </Typography>
...
Right to be free from discrimination: Punch Games will not discriminate against you for exercising any of your rights under the CCPA. 
          </Typography>
...
Punch Games can be by email at contact@fantasygame.me. 
          </Typography>
...
To contact us with your questions or comments regarding this Privacy Policy or the information collection and dissemination practices of the Punch Games SDK, please email us at contact@fantasygames.com. 
          </Typography>
        </Box>
      </Container>
    </Box>
